...
public class RestapiSwaggerConfiguration {
    ...
    public Docket api10Docket() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors
                        .basePackage("com.ericsson.restapi"))
                .paths(PathSelectors.regex("/courses/v1.0.*"))
                .build()
                .apiInfo(getApiInfo())
    ...
    public Docket ap11Docket() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors
                        .basePackage("com.ericsson.restapi"))
                .paths(PathSelectors.regex("/courses/v1.1.*"))
                .build()
                .apiInfo(getApiInfo())
                .forCodeGeneration(true)
                .genericModelSubstitutes(ResponseEntity.class)
    ...
    private ApiInfo getApiInfo() {
        return new ApiInfo(
                ...
                "0.0.1-SNAPSHOT",
                "Terms of Service",
                new Contact("Rohitash Pathak",
                        "https://blog.rohitash.in",
                        "rohitashpathak89@gmail.com"),
                "OSS License",
                "https://blog.rohitash.in",
